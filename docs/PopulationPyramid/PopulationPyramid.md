...
| data                         | Array<PopnPyramidItem>    | array of objects, each object is described by **PopnPyramidItem**                                                | \_                       |
...
Each object in the data array is of `PopnPyramidItem` type. Only these 2 properties are mandatory- `left` and `right`, all other properties are optional. <br/>
