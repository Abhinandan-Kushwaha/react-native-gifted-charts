...
| x                           | number                    | Custom X value for this bubble. When not provided, it is auto-calculated based on the bubble's index and total width, accounting for the bubble's radius. |
...
| value                       | number                    | Alternate for y. For uniformity across charts. If value is present instead of y in the data array, it is treated as y. (lint error as y is required)      |
