...
| pieInnerComponentHeight     | number               | inner component's size is determined by innerRadius, but can be overridden using `pieInnerComponentHeight` | innerRadius                                    |
| pieInnerComponentWidth      | number               | inner component's size is determined by innerRadius, but can be overridden using `pieInnerComponentWidth`  | innerRadius                                    |
