  ...
  return (
    <View style={{justifyContent: 'center', alignItems: 'center'}}>
      <Svg
        ...
        style={{backgroundColor: chartContainerProps.backgroundColor}}>
        <G
          translateX={chartContainerProps.shiftX}
          translateY={chartContainerProps.shiftY}>
              ...
              return labels?.map((label, labelIndex) => {
                ...
                return (
                  <SvgText
                    ...
                    fontFamily={dataLabelsFontFamily}
                    textAnchor={
                      (dataLabelsTextAnchor as TextAnchor) ?? 'middle'
                    }
                    alignmentBaseline={
